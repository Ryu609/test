...
var content_ref_class_1 = require("./content-ref.class");
    ...
    ComponentLoader.prototype._getContentRef = function (content) {
        ...
        if (content instanceof core_1.TemplateRef) {
            if (this._viewContainerRef) {
                ...
                return new content_ref_class_1.ContentRef([viewRef_1.rootNodes], viewRef_1);
            }
        ...
        if (typeof content === 'function') {
            ...
            var modalContentInjector = core_1.ReflectiveInjector.resolveAndCreate(this._providers.concat([content]), this._injector);
